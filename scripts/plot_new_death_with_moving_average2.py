...
#setting up the out file path
script_dir = os.path.dirname(__file__)
out_path_linear = "../plots/lacounty_total_new_deaths_7_day_average_linear.png" #this line creates a file with log scale in y axis
out_path_log = "../plots/lacounty_total_new_deaths_7_day_average_log.png" #this line creates a file with log scale in y axis
